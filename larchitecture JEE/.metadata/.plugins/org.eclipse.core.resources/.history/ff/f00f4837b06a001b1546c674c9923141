...
public class ProduitDaoImpl implements IProduitDao {
	...
	public Produit save(Produit p) {
		Connection connection=SingletonConnection.getMyConnexion();
		try {
	...
	public Produit update(Produit p) {
		...
		Connection connection=SingletonConnection.getMyConnexion();
		try {
			PreparedStatement ps=connection.prepareStatement("UPDATE PRODUITS  SET produits.DESIGNATION=?,produits.PRIX=?,produits.QUANTITE=? WHERE =?");
